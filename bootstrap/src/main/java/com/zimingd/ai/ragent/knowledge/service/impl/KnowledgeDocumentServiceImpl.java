...
package com.zimingd.ai.ragent.knowledge.service.impl;
...
import com.zimingd.ai.ragent.core.chunk.ChunkEmbeddingService;
import com.zimingd.ai.ragent.core.chunk.ChunkingMode;
import com.zimingd.ai.ragent.core.chunk.ChunkingOptions;
import com.zimingd.ai.ragent.core.chunk.ChunkingStrategy;
import com.zimingd.ai.ragent.core.chunk.ChunkingStrategyFactory;
import com.zimingd.ai.ragent.core.chunk.VectorChunk;
import com.zimingd.ai.ragent.core.parser.DocumentParserSelector;
import com.zimingd.ai.ragent.core.parser.ParserType;
...
import com.zimingd.ai.ragent.framework.mq.producer.MessageQueueProducer;
import com.zimingd.ai.ragent.ingestion.dao.entity.IngestionPipelineDO;
import com.zimingd.ai.ragent.ingestion.dao.mapper.IngestionPipelineMapper;
import com.zimingd.ai.ragent.ingestion.domain.context.IngestionContext;
import com.zimingd.ai.ragent.ingestion.domain.pipeline.PipelineDefinition;
import com.zimingd.ai.ragent.ingestion.engine.IngestionEngine;
import com.zimingd.ai.ragent.ingestion.service.IngestionPipelineService;
import com.zimingd.ai.ragent.knowledge.config.KnowledgeScheduleProperties;
import com.zimingd.ai.ragent.knowledge.controller.request.KnowledgeChunkCreateRequest;
import com.zimingd.ai.ragent.knowledge.controller.request.KnowledgeDocumentPageRequest;
import com.zimingd.ai.ragent.knowledge.controller.request.KnowledgeDocumentUpdateRequest;
import com.zimingd.ai.ragent.knowledge.controller.request.KnowledgeDocumentUploadRequest;
import com.zimingd.ai.ragent.knowledge.controller.vo.KnowledgeChunkVO;
import com.zimingd.ai.ragent.knowledge.controller.vo.KnowledgeDocumentChunkLogVO;
import com.zimingd.ai.ragent.knowledge.controller.vo.KnowledgeDocumentSearchVO;
import com.zimingd.ai.ragent.knowledge.controller.vo.KnowledgeDocumentVO;
...
import com.zimingd.ai.ragent.knowledge.dao.entity.KnowledgeDocumentChunkLogDO;
...
import com.zimingd.ai.ragent.knowledge.dao.mapper.KnowledgeDocumentChunkLogMapper;
...
import com.zimingd.ai.ragent.knowledge.enums.ProcessMode;
import com.zimingd.ai.ragent.knowledge.enums.SourceType;
import com.zimingd.ai.ragent.knowledge.handler.RemoteFileFetcher;
import com.zimingd.ai.ragent.knowledge.mq.event.KnowledgeDocumentChunkEvent;
import com.zimingd.ai.ragent.knowledge.schedule.CronScheduleHelper;
import com.zimingd.ai.ragent.knowledge.service.KnowledgeChunkService;
import com.zimingd.ai.ragent.knowledge.service.KnowledgeDocumentScheduleService;
import com.zimingd.ai.ragent.knowledge.service.KnowledgeDocumentService;
import com.zimingd.ai.ragent.rag.core.vector.VectorSpaceId;
import com.zimingd.ai.ragent.rag.core.vector.VectorStoreService;
