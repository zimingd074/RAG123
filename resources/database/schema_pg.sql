...
CREATE TABLE t_knowledge_vector (
    ...
    identifier_tokens TEXT[] GENERATED ALWAYS AS (
...
COMMENT ON COLUMN t_intent_node.kb_ids IS '知识库ID列表(JSON)，kb_id为首库兼容字段';
...
COMMENT ON COLUMN t_intent_node.collection_names IS '关联的Collection列表(JSON)';
